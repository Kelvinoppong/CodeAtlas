...
from app.api import projects, snapshots, files, symbols, ai, changesets, auth, websocket, system, impact, architecture
...
app.include_router(impact.router, prefix="/snapshots/{snapshot_id}/impact", tags=["Impact Analysis"])
app.include_router(architecture.router, prefix="/snapshots/{snapshot_id}/architecture", tags=["Architecture"])
